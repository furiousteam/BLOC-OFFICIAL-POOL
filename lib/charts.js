...
function getPoolHashrate(callback) {
    getPoolStats(function(error, stats) {
        callback(error, typeof stats !== 'undefined' ? Math.round(stats.pool.hashrate) : null);
    });
}

function getPoolWorkers(callback) {
    getPoolStats(function(error, stats) {
        callback(error, typeof stats !== 'undefined' ? stats.pool.miners : null);
    });
}

function getNetworkDifficulty(callback) {
    getPoolStats(function(error, stats) {
        callback(error, typeof stats !== 'undefined' ? stats.network.difficulty : null);
    });
}
